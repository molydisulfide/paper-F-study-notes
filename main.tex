...
\begin{enumerate}[label=\textbf{Question \arabic*}]
    ...
    \begin{itemize}[label=(\alph*)]
        \item A cabinet substantially as hereinbefore described with reference to any one of the accompanying Figures 1 to 5.
        \item A cylinder head (12) for a motor engine (1) characterised in that ...
        \item A (concrete) moulded brick characterised by ...
        \item Chemical substance comprising (meth)acrylate ..."
    \end{itemize}
