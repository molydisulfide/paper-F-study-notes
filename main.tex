...
\begin{enumerate}[label=\textbf{Answer \arabic*}]
    ...
    \begin{enumerate}[label=(\alph*)]
        \item What is the priority situation today?
        \item Would your answer have been different if EP had been filed by Companies X and Y as joint applicants?
    \end{enumerate}
    ...
    For each of the statements below, indicate whether the statement is true or false.
    \begin{enumerate}[label=(\alph*)]
        \item EP1 validly claims priority from DE2.
        \item EP2 validly claims priority from DE1.
    \end{enumerate}
