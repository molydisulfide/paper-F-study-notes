...
\begin{enumerate}[label=\textbf{Question \arabic*}, leftmargin=*]
    ...
    \begin{enumerate}[label=(\alph*)]
        \item By when must an appeal be filed?
        \item Is this period extendable?
        \item When must the appeal fee be paid? What is the amount? Any reduction possible when the opponent is a person referred to in Article 14(4) EPC?
        \item Can a late filing of the notice of appeal or a late payment of the appeal fee be remedied with further processing or re-establishment of rights?
    \end{enumerate}
\vspace{1cm}
    % --- Question 2 ---
    ...
    \begin{enumerate}[label=\textbf{Case \arabic*}, leftmargin=3.5em]
        ...
        \textbf{1.} There must be an interlocutory revision.
        ...
        \textbf{2.} There must be an interlocutory revision.
        ...
        \textbf{3.} There must be an interlocutory revision.
        ...
        \textbf{4.} There must be an interlocutory revision.
        ...
        \textbf{5.} There must be an interlocutory revision.
        ...
        \textbf{6.} There must be an interlocutory revision.
        ...
        \begin{enumerate}[label=\textbf{7.\arabic*}]
            \item There must be an interlocutory revision.
            \item Interlocutory revision must even be made if it is expected to result in a further refusal after oral proceedings have been held.
            \item If interlocutory revision is made, the appeal fee must be refunded.
        \end{enumerate}
        ...
        \textbf{8.} There must be an interlocutory revision.
    \end{enumerate}
\vspace{1cm}
    % --- Question 3 ---
    \item H10-17 \\
    ...
    \begin{enumerate}[label=(\alph*)]
        \item The notice of appeal is not signed.
        \item The address of the appellant is incomplete.
        \item The notice of appeal is filed by the patent proprietor following a decision of the Opposition Division to maintain the patent based on the main request and in a form as amended by the proprietor.
        \item The grounds give a mere reference in general terms to passages in the literature showing the state of the art and to the Guidelines without making their inference sufficiently clear.
    \end{enumerate}
    ...
    For each of the statements below, indicate whether the statement is true or false:
    \begin{enumerate}[label=\Alph*.]
        \item A notice of appeal against the decision to refuse the patent application must be filed at the latest by 19 April 2021.
        \item The statement setting out the grounds of appeal and possibly amendments must be filed together with the notice of appeal.
        \item The examining division shall rectify its decision if it finds the appeal to be admissible and well-founded.
        \item The appeal fee is always reimbursed, if the board of appeal sets aside the decision of the examining division.
    \end{enumerate}
\vspace{1cm}
    % --- Question 5 ---
    \item H10-24 (Basic selection)
    \begin{enumerate}[label=(\alph*)]
        \item Can a decision of a Board of Appeal be challenged?
        \item On which grounds may a petition for review be based?
        \item Does a petition for review have suspensive effect? Why (not)?
        \item Are third parties protected at all if a successful petition for review results in the revival of lost patent protection?
    \end{enumerate}
