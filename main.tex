...
\p Therefore, the alleged effect cannot be used to support inventive step. - Art. 56 EPC \\
    ...
    \begin{enumerate}[label=(\alph*)]
        \item What happens to the prior right effect of a conflicting earlier European patent application if that application was withdrawn before the date of publication?
        \item After publication of the earlier European patent application, the applicant withdraws the priority claim. What happens to the prior right effect?
    \end{enumerate}
    ...
    \vspace{1em}
    Comment: "Future energy: Solutions for Tackling Mankind's Greatest Challenge" was a recognised International Exhibition, see OJ 2016 A38:
    ...
    \vspace{1em}
    Is the claim novel in EP-A in view of EP-B?
    ...
    \begin{enumerate}[label=(\alph*)]
        \item Is the claim novel in EP-A in view of EP-B?
        \item Would your answer have been different if EP-B had enumerated all halogens?
        \item Would your answer to the questions (a) and (b) have been different if EP-B was a normal prior art document? (= prior art under Art.54(2) EPC)
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item Substance X for use in a method for the treatment of Y
        \item Substance X for use in the therapy of Y
        \item Substance X for use in a method of treating Y
        \item Substance X for use in a method of therapy of Y
        \item Substance X for use as an anti-inflammatory medicament (where the medicament is defined by its function)
        \item Composition comprising X for use in a method for the treatment of Y
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*), resume]
        \item Substance X for use in a method for the treatment of Y wherein the substance is administered topically
        \item Substance X for use in the therapy of Y wherein the substance is administered three times daily
        \item Substance X for use in a method of treating Y wherein the substance is administered three times daily at a dose in a range of 10-20 mg
        \item Substance X for use in a method of therapy of Y wherein the substance is administered topically
        \item Substance X for use as an anti-inflammatory medicament wherein the substance is administered topically (where the medicament is defined by its function)
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*), resume]
        \item Substance X for a method for the treatment of Y
        \item Substance X in a method for the treatment of Y
        \item Medicament for topical treatment
        \item Anti-inflammatory medicament for topical treatment
        \item Pharmaceutical comprising substance X for topical treatment
        \item Composition comprising X as an anti-inflammatory agent
        \item Composition comprising X for use as an antifungal agent
        \item Composition comprising X for use as an antibacterial agent
    \end{enumerate}
\end{enumerate}
\end{enumerate}
\end{enumerate}
