...
\begin{enumerate}[label=\textbf{Question \arabic*}]
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \begin{enumerate}[label={(\alph{enumi}.\arabic*)}]
            ...
            \item In case the filing and search fee are not paid in time, the EPO sends a communication concerning the failure to observe the time limit. FP can be performed by completing the omitted act, i.e. pay the filing and search fee, within two months from the communication, and payment of the flat FP fee of RFees 2(1).12, last dash. \T --- ``last dash'' refers to \textit{other cases} though...
            \item In case the filing and search fee are not paid in time, the EPO sends a communication concerning the failure to observe the time limit. RE in respect of the one month time limit for payment of the filing and search fee can be applied if all due care can be proven. \T --- see \textit{\textbf{Lobato}; page 203}.
        ...
        \begin{enumerate}[label={(\alph{enumi}.\arabic*)}]
            ...
            \item An additional fee shall be paid for 9 pages (Fees 2(1).1a) and at the latest on 14/5/2019.        \F --- it needs to be paid within \textbf{1 month} of filing but it is missing claims and will fail \textbf{R. 57(c) EPC}, so likely EPO will invite under \textbf{R. 58 EPC} and give \textbf{2 months} to pay from the date of invitation.
    ...
    \begin{enumerate}[label=(\alph*)]
        \item The filing date accorded to the European patent application is 18/4/2017.
        \item The filing fee of Fees 2(1).1 may be validly paid until 18/5/2017. An additional fee under RFees 2(1).1a must be paid within the same period.
        \item The filing fee of Fees 2(1).1 may be validly paid until 6/6/2017. Any additional fee under Fees 2(1). 1a must be paid within the same period.
        \item Failure to pay the filing and search fee will result in the application being deemed not filed.
        \item Failure to pay the filing and search fee will result in the application being deemed withdrawn.
        \item Failure to pay the additional fee of Fees 2(1).1a will result in the application being deemed withdrawn.
        \item Failure to pay the additional fee of Fees 2(1).1a will result in a communication with an invitation to pay the additional fee within one month of the communication.
        \item Failure to pay the claims fees will result in the application being deemed withdrawn.
        \item Failure to pay the claims fees will result in a communication with an invitation to pay the claims fees within one month of the communication.
        \item Failure to pay the claims fees will result in a communication with an invitation to pay the claims fees within one month of the communication with an additional fee of 50\% of the claims fees.
        \item Failure to pay the claims fees in response to the communication with the invitation to pay the claims fees may be remedied by payment of the claims fees and an additional 50\% of the claims fees in response of a loss-of-rights communication of the EPO.
    \end{enumerate}
    ...
    For each of the statements below, indicate whether the statement is true or false.
    \begin{enumerate}[label=(\alph*), resume]
        \item The examination fee had to be paid at the latest on 22/5/2018.
        \item The designation fee had to be paid at the latest on 25/4/2018.
    \end{enumerate}
    ...
    For each of the statements below, indicate whether the statement is true or false.
    \begin{enumerate}[label=(\alph*), resume]
        \item Non-payment of the examination fee will result in the application being deemed withdrawn with further processing available as remedy.
        \item Non-payment of the designation fee will result in the application being deemed withdrawn with further processing available as remedy.
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item sends his European patent application to the EPO by registered mail, date stamped at his local post office at Thursday 8 September 2022 and delivered to the EPO in The Hague on Friday 9 September 2022;
        \item sends European patent application to the EPO by registered mail, date stamped at his local post office at Saturday 10 September 2022 and delivered to the EPO in The Hague on Monday 12 September 2022;
        \item submits his European patent application to the EPO by EPO Online Filing 2.0 on Saturday 10 September 2022;
        \item hands his European patent application to the reception at the EPO in The Hague on Saturday 10 September 2022;
        \item puts his European patent application in the automated mailbox at the EPO in Berlin on Saturday 10 September 2022;
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item For each of the statements below, indicate whether the statement is true or false.
        \begin{enumerate}[label={(\alph{enumi}.\arabic*)}]
            \item This is possible by filing a Request-for-Grant form with all necessary information in the relevant boxes filled in.
            \item This is not allowed, because the priority period has already expired.
        \end{enumerate}
        ...
        For each of the statements below, indicate whether the statement is true or false.
        \begin{enumerate}[label={(\alph{enumi}.\arabic*)}]
            \item The filing date accorded to the new European patent application will be 14 March 2023 if the applicant provides the file number within a period of 2 months from an invitation of the EPO to do so.
            \item The filing date accorded to the new European patent application will be 14 March 2023, but the application will be deemed withdrawn if the applicant fails to provide the file number within a period of 2 months from an invitation of the EPO to do so, but remedies this failure with further processing.
        \end{enumerate}
    \end{enumerate}
    ...
    \begin{enumerate}[label=\Alph*.]
        \item File the claims as missing parts, which allows to maintain the filing date because the claims were completely contained in the priority document.
        \item File the claims in their original form within 2 months from an invitation under Rule 55 EPC.
        \item File the claims in their original form within 2 months from an invitation under Rule 58 EPC.
        \item None of A-C.
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item Until when may another divisional DIV3 be filed out of EP1, directed to C?
        \item Until when may another divisional DIV4 be filed out of DIV1, directed to C?
        \item Until when may another divisional DIV5 be filed out of DIV2, directed to C?
    \end{enumerate}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item The loss of rights communication indicates that the application is refused.
        \item The loss of rights ensues at the end of 23 November 2018
        \item The loss of rights ensues at the end of 3 December 2018.
        \item The loss of rights ensues at the end of 13 December 2018.
        \item The loss of rights ensues at the end of 23 December 2018.
        \item The loss of rights ensues at the end of 24 February 2019.
        \item As the loss of rights may still be remedied with further processing and the term for requesting further processing has not yet expired, the parent application was still pending when the divisional was filed. No further processing of any kind is needed.
        \item As the parent was no longer pending when DIV1 was filed, DIV1 was filed too late. However, this failure may be remedied by requesting further processing in respect of the missed term for filing the divisional.
        \item As the parent was no longer pending when DIV1 was filed, DIV1 was filed too late. However, this failure may be remedied by requesting further processing in respect of the missed terms for paying the examination and designation fee for the parent application.
    \end{enumerate}
