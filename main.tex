...
\begin{enumerate}[label=\textbf{Question \arabic*}, leftmargin=*]
    ...
    \begin{itemize}[leftmargin=3.5em]
        \item[\textbf{(b.1)}] As Company X no longer exists as a legal entity, no opponents remain. Opposition may however continue at the EPO own motion.
        \item[\textbf{(b.2)}] As Company Z is the universal successor of Company X, Company Z will replace Company X as opponent.
    \end{itemize}
    ...
    \begin{itemize}[leftmargin=3.5em]
        \item[\textbf{(c.1)}] Upon receipt of the notice of withdrawal, the EPO will terminate the opposition appeal proceedings, as no Opponents remain.
        \item[\textbf{(c.2)}] After receipt of the notice of withdrawal, the EPO may continue the opposition appeal proceedings at its own motion under R.84(2), last sentence.
    \end{itemize}
    ...
    \textbf{(a) Signature:}
    \begin{itemize}[leftmargin=3.5em]
        \item[\textbf{(a.1)}] A signature is required. If the signature is not provided on the same day, the opposition will be deemed not to have been filed.
        \item[\textbf{(a.2)}] A signature is required. The opponent will be invited to provide it within a period set by the EPO. If provided, the opposition is validly filed.
        \item[\textbf{(a.3)}] A signature is required. If not provided within the set period, the opposition is deemed inadmissible.
    \end{itemize}

    \textbf{(b) Fee:}
    \begin{itemize}[leftmargin=3.5em]
        \item[\textbf{(b.1)}] If the deficiency is not timely rectified, the opposition fee will be refunded.
        \item[\textbf{(b.2)}] Irrespective of whether the deficiency is rectified or not, the opposition fee will not be refunded.
    \end{itemize}
    ...
    \begin{itemize}[leftmargin=3.5em]
        \item[\textbf{(a.1)}] ... On the ground of lack of novelty over public prior use in Australia.
        \item[\textbf{(a.2)}] ... On the ground of non-patentability of methods for treatment of the animal body by surgery.
        \item[\textbf{(a.3)}] ... On the ground of lack of unity.
        \item[\textbf{(a.4)}] ... On the ground of lack of clarity of the claims.
        \item[\textbf{(a.5)}] ... against a patent granted from a divisional application on the ground of extension beyond the content of the parent.
    \end{itemize}

    \textbf{(b) Based on arguments...}
    \begin{itemize}[leftmargin=3.5em]
        \item[\textbf{(b.1)}] ... as to lack of novelty over an intermediate prior art document in combination with an invalid priority claim.
        \item[\textbf{(b.2)}] ... that the description is so unclear that the skilled person cannot carry it out.
        \item[\textbf{(b.3)}] ... that the applicant is not entitled to the patent.
    \end{itemize}

    \textbf{(c) An opposition is limited to...}
    \begin{itemize}[leftmargin=3.5em]
        \item[\textbf{(c.1)}] ... the grounds of opposition given in the notice of opposition.
        \item[\textbf{(c.2)}] ... the extent of opposition given in the notice of opposition.
        \item[\textbf{(c.3)}] ... the facts and evidence cited in the notice of opposition.
    \end{itemize}
    ...
    \begin{itemize}[label=\alph*)]
        \item The opposition will be considered filed.
        \item The opposition will be considered admissible.
    \end{itemize}
    ...
    \begin{itemize}[label=\alph*)]
        \item A notice of opposition must be filed at the latest by 29 March 2023.
        \item If filed against claim 1 only, it can be extended to claim 2 after the expiry of the opposition period.
        \item The statement setting out the grounds for opposition must be filed at the latest by 29 May 2023.
        \item Lack of unity of the invention is a valid ground for opposition.
    \end{itemize}
    ...
    \begin{itemize}[label=--]
        \item Is the opponent correct that the OD must always examine clarity of claims amended during proceedings (referring to G 9/91)?
        \item Can the Opposition Division object to the amended claim as lacking clarity?
    \end{itemize}
    ...
    \begin{itemize}[label=\alph*)]
        \item What is the legal situation/priority of proceedings?
        \item Does the prior art document found by the Japanese patent office have to be filed when requesting limitation?
        \item Would the answer to (a) be different if the proprietor requested revocation?
    \end{itemize}
    ...
    \begin{itemize}[label=\alph*)]
        \item The third party can file a 1967 publication as third party observations during limitation proceedings.
        \item The EPO will examine the request for limitation for novelty.
        \item The third party can file the publication as third party observations after the decision to limit is published.
        \item The third party may file a notice of opposition until 25 February 2023.
    \end{itemize}
